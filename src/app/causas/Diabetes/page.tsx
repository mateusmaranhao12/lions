            ...
            <div className="grid md:grid-cols-1 gap-8 items-center mb-10">
                ...
                <div className="relative w-48 h-48 rounded-full overflow-hidden mx-auto shadow-lg">
                    ...
                    <div
                        ...
                        style={{ backgroundImage: "url('/assets/diabete.jpg')" }}
                    ></div>
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center h-full text-center p-4">
                        <Image src="/assets/causas3.png" alt="Diabetes" width={80} height={80} className="mb-3" />
                        <h2 className="text-lg font-semibold">Diabetes</h2>
                    </div>
                </div>
